...
#Step 2
estimated_start_time_raw <- as.POSIXct("2025-01-20 11:37:30.000")
...
```{r}
raw_df <- Walk1
temp <- filter(Walk1, time > as.POSIXct("2025-01-20 11:37:41.000"), time <  as.POSIXct("2025-01-20 11:37:45.000"))
plot(temp$Z, type = 'l')
```
