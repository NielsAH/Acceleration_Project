...
plot(cumsum(data_to_analyse_new$X*9.80665/30), type = 'l')
```
...
#as.POSIXct("2025-04-08 11:09:23.800") #Start of treadmill video
data <- Glue_and_classify(unordered_data, 3, 3, 150, 150, 150, T, 20, 5, ma_gauss, sigma = 1)
correction_fw_10_orient1 <- 1.873
data_10km_orient1 <- data[[1]]$data
(cumsum(data_10km_orient1$acc_fw*9.80665/30) + correction_fw_10_orient1) %>% plot(type = 'l')
(cumsum(data_10km_orient1$acc_side*9.80665/30)) %>% plot(type = 'l')
(cumsum(data_10km_orient1$acc_vert*9.80665/30)) %>% plot(type = 'l')
```