...
1. Make a folder called frames (if you want to preserve the current infrastructure. This folder should be present with an example as well). Within this folder, add a new empty folder with a name of your choice. Say, "ExampleName" and assign it to the variable folder_name. Add the video to this folder and give it the same name as the folder (in this case ExampleName). You may want to change the scale parameter depending on the device with which the vide is taken and if it is vertical or horizontal
...
no_of_thousands <- 1 + vid_frames %/% 1000
for(j in 0:(no_of_thousands-1)){
...
Semi-automated start time generator
```{r}
streamvid <- "raw"
stream1 <- "X"
stream2 <- "Y"
