...
data_walkW8 <- generate_data(folder_name,
                width, 
                start_time, 
                df,
                wdw_size,
...
steps_info_walkW8 <- df_all_from_mvm_alt_nofilter(data_walkW8, 200, min_square_difference_vert)

generate_images_avg(steps_info_walkW8, 0.8, folder_name)
...
shiny_walkW8 <- generate_server(vid_frames,
                         folder_name,
                         streamvid,
                         stream1,
                         stream2,
...
shinyApp(ui = shiny_walkW8[[1]], server = shiny_walkW8[[2]])
```

## Example of finding a precise starting time, applied to walkW8

```{r}
#step 1
raw_df <- Walk3
raw_folder_name <- "walkW8"
...
shiny_walkW8_raw <- generate_server(raw_vid_frames,
                         raw_folder_name,
                         raw_streamvid,
                         raw_stream1,
                         raw_stream2,
...
shinyApp(ui = shiny_walkW8_raw[[1]], server = shiny_walkW8_raw[[2]])
```
...
## Example of finding an estimated starting time, applied to walkW8
