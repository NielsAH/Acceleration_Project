...
data_walkW4 <- generate_data(folder_name,
                width, 
                start_time, 
                df,
                wdw_size,
...
steps_info_walkW4 <- df_all_from_mvm_alt_nofilter(data_walkW4, 200, min_square_difference_vert)

generate_images_avg(steps_info_walkW4, 0.8, folder_name)
...
shiny_walkW4 <- generate_server(vid_frames,
                         folder_name,
                         streamvid,
                         stream1,
                         stream2,
...
shinyApp(ui = shiny_walkW4[[1]], server = shiny_walkW4[[2]])
```

## Example of finding a precise starting time, applied to walkW4

```{r}
#step 1
raw_df <- Walk2
raw_folder_name <- "walkW4"
...
shiny_walkW4_raw <- generate_server(raw_vid_frames,
                         raw_folder_name,
                         raw_streamvid,
                         raw_stream1,
                         raw_stream2,
...
shinyApp(ui = shiny_walkW4_raw[[1]], server = shiny_walkW4_raw[[2]])
```
...
## Example of finding an estimated starting time, applied to walkW4
