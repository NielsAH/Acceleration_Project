...
start_time <-   as.POSIXct("2025-01-20 15:00:12.000")
...
#Step 2
estimated_start_time_raw <- as.POSIXct("2025-01-20 15:00:12.000")
...
```{r}
temp <- filter(Walk2, time > as.POSIXct("2025-01-20 15:00:12.000"), time <  as.POSIXct("2025-01-20 15:00:21.000"))
plot(temp$Y, type = 'l')
```
